...
namespace Bit.Core.Models.Business
{
    ...
    public class InstallationProtectedString
    {
        ...
        private InstallationProtectedString(byte[] data, byte[] iv, byte[] mac)
        {
            IV = iv;
            Data = data;
            Mac = mac;
        ...
        public InstallationProtectedString(string encryptedString)
        {
        ...
        public static InstallationProtectedString Encrypt(string clearText, string password)
        {
            var (encKey, macKey) = DeriveKey(password);
            byte[] data;
            byte[] mac;
            ...
            return new InstallationProtectedString(data, iv, mac);
        }
